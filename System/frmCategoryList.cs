...
namespace System
{
    public partial class frmCategoryList : Form
    {
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                frmCategory frm = new frmCategory(this);
                frm.txtCategory.Text = dataGridView1.Rows[e.RowIndex].Cells[1].Value.ToString();
                frm.txtDesc.Text = dataGridView1.Rows[e.RowIndex].Cells[2].Value.ToString();
            ...
            }else if (colName == "Delete")
            {
                ...
                {
                    cn.Open();
                    cm = new SqlCommand("delete from tblCategory where dpcode like '" + dataGridView1.Rows[e.RowIndex].Cells[1].Value.ToString() + "'" , cn);
                    cm.ExecuteNonQuery();
                    cn.Close();
